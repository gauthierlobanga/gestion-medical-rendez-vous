...
class DashboardDisponibilite extends BaseDashboard
{
    use HasFiltersAction;
    use HasFiltersForm;

    protected static ?string $title = 'Disponibilité Dashboard';
    protected static string $routePath = 'disponibilite';
